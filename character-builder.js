...
const CharacterBuilder = {
    ...
    itemPositions: {
        ...
        head: {
            ...
            plug: { x: 250, y: 270, width: 230, height: 200, scale: 2.45, zIndex: 6 },
            tap7: { x: 250, y: 255, width: 265, height: 180, scale: 2.45, zIndex: 6 }
        },
        
        // Shirt/Neck accessories (ornaments) - adjusted positions (moved up and made larger)
        shirt: {
            collar: { x: 250, y: 260, width: 190, height: 150, scale: 2, zIndex: 7 },
            bowtie: { x: 250, y: 260, width: 190, height: 150, scale: 2, zIndex: 7 },
            medal: { x: 250, y: 260, width: 190, height: 150, scale: 2, zIndex: 7 },
            workaholic: { x: 250, y: 260, width: 190, height: 150, scale: 2, zIndex: 7 }
        },
    ...
    getItemImageUrl(category, itemName) {
        ...
        const imageMap = {
            background: {
                ...
                flower: './website/background/4.png',
                fireworks: './website/background/1.png',
                meadow: './website/background/2.png',
                starry: './website/background/3.png'
